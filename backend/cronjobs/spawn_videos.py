...
from lib.spawn_videos import find_video_request_formats_and_spawn_videos
...
if __name__ == "__main__":
    ...
    asyncio.run(find_video_request_formats_and_spawn_videos(max_count=args.max_count,
                batch_size=args.batch_size, change_status=args.change_status, insert_videos=args.insert_videos))
